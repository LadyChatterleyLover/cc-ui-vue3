<template>
  <cc-popup mode="bottom"  v-model:show="value" :showMask="showMask" ref="popup">
...
import { defineProps, defineEmits, watch, ref, PropType, computed } from 'vue'
...
let props = defineProps({
  ...
  // 键盘模式 数字还是身份证
  mode: {
    type: String as PropType<'number' | 'card'>,
    default: 'number'
  },
  // 是否打乱键盘顺序
  random: {
...
let emits = defineEmits(['update:value', 'change', 'backspace', 'cancel', 'confirm'])


// 乱序数组
let randomArr = (arr: any[]) => {
  return arr.sort(() => {
